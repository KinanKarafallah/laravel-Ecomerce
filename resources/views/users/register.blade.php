        ...
        <div id="image" class="hidden bg-cover lg:block lg:w-2/3" >
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                <div>
                    ...
                    <p class="max-w-xl mt-3 text-gray-300">Create an account and get new meaning of shopping</p>
                    <a href="/">
                        <button class="mt-3 rounded-xl bg-gradient-to-r from-green-400 to-blue-500 px-5 py-3 text-base font-medium text-white transition duration-200 hover:shadow-lg hover:shadow-[#6025F5]/50 transition-transform duration-200 ease-in-out hover:scale-[1.03]">
                            Back to Homepage
                        </button>
                    </a>
                </div>
